...
def rules_game(message: telebot.types.Message):
    text = ("Отлично, но для начала раунда необходимо ознакомится с некоторыми правилами:"
            ...
            '\n             1. "[]" - таким символом будут обозначаться однопалубные корабли на игровом поле (Боевой катер);'
            '\n             2. "[ ]" - таким символом будут обозначаться 2-х палубные корабли на игровом поле (Линкор);'
            '\n             2. "[ = ]" - таким символом будут обозначаться 3-х палубные корабли на игровом поле (Эсминец);'
